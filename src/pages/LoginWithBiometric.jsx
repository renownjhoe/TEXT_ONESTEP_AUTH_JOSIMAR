...
const BiometricsLogin = () => {
  ...
  }, [faceIDSetup, touchIDSetup, navigate]);
        ...
        <div className="max-w-md w-full space-y-6">
          ...
          <div className="flex flex-col justify-center items-center">
            <button
              ...
              className={`w-full bg-gray-800 hover:bg-gray-700 text-white rounded-lg py-3 flex flex-col items-center justify-center ${touchIDSetup ? 'border-2 border-green-500' : ''
                }`}
            >
            ...
            <button
              ...
              className={`w-full bg-gray-800 hover:bg-gray-700 text-white rounded-lg py-3 flex flex-col items-center justify-center ${faceIDSetup ? 'border-2 border-green-500' : ''
                }`}
            >
