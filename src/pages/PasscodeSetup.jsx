...
const SetupPasscode = () => {
    ...
    const validatePasscode = () => {
        ...
        if (passcode.length < 4) {
            ...
            newErrors.push('Passcode must be at least 4 digits');
        ...
        // Use userData.dob instead of the form input

        if (userData.dob && passcode.includes(userData.dob.replace(/\D/g, ''))) {
    ...
    const handleSubmit = (e) => {
        ...
        if (!passcode) {
            setErrors('Passcode is required');
            hasErrors = true;
        } else if (isPasscodeSimilarToDOB(passcode, state.user?.dob || '')) {
            setErrors('Passcode cannot be similar to your date of birth.');
            hasErrors = true;
        } else if (!isPasscodeStrong(passcode)) {
            setErrors('Passcode must be at least 8 characters long and contain a letter and a number.');
            hasErrors = true;
        } else {
            setErrors(null);
        }
        ...
        if (validatePasscode()) {
            ...
            // Include the user data and the passcode in the SET_USER action.
            dispatch({ type: 'SET_PASSCODE', payload: { passcode: passcode, userData: userData } });
                ...
                <div className="max-w-md w-full space-y-6">
                    ...
                    <div className="flex justify-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <span>Transaction Request Form</span>
